...
export interface ImageSlot { id: string; status: string; attempts: number; error?: string; requirement: { imageSource: string; sectionTitle?: string }; result?: { url: string; method: string } }
